...
Runs natively on Linux and modern Windows. Supports raw disks, legacy E-MU DOS executables, and full or partial ROMs.
...
Floppy drive issues (bad sectors, mechanical failures) are normal, use freshly formatted disks before writing.
